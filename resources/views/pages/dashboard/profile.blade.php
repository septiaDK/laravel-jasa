                                ...
                                <div class="px-4 py-5 sm:p-6">
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @if ($errors->has('photo'))
                                                <p class="text-red-500 mb-3 text-small">{{ $errors->first('photo') }}</p>
                                            @endif
                                        </div>
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            <label for="name" class="block mb-3 font-medium text-gray-700 text-md">Full
                                                Name</label>
                                            <input placeholder="Alex Jones" type="text" name="name" id="name"
                                                autocomplete="name"
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="Website Developer" type="text" name="role" id="role"
                                                autocomplete="role"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                                value="{{ $user->detail_user->role ?? '' }}" required>

                                            @if ($errors->has('role'))
                                                <p class="text-red-500 mb-3 text-small">{{ $errors->first('role') }}</p>
                                            @endif
                                        </div>
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            <label for="email" class="block mb-3 font-medium text-gray-700 text-md">Email
                                                Address</label>
                                            <input placeholder="Alex.jones@gmail.com" type="text" name="email" id="email"
                                                autocomplete="email"
                                                class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                        ...
                                        <div class="md:col-span-6 lg:col-span-3">
                                            ...
                                            <input placeholder="087721205555" type="number" name="contact_number"
