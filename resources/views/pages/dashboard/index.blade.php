                ...
                <div class="col-span-4 text-right">
                    <div @click.away="open = false" class="relative z-10 hidden mt-5 lg:block" x-data="{ open: false }">
                        <button
                            ...
                            @else
                                <svg class="inline w-12 h-12 rounded-full text-gray-300" fill="currentColor"
                                    viewBox="0 0 24 24">
                                    <path
                                        ...
                                        <td class="w-1/3 px-1 py-5">
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    ...
                                                    @if (auth()->user()->detail_user()->first()->photo != null)
                                                        <img src="{{ url(Storage::url(auth()->user()->detail_user()->first()->photo)) }}"
                                                            alt="photo service" class="inline w-12 h-12 mr-3 rounded-full">
                                                    @else
                                                        <svg class="inline w-12 h-12 rounded-full text-gray-300"
                                                ...
                                                <div>
                                                    <p class="font-medium text-black">{{ $item->order_buyer->name ?? '' }}
                                                    </p>
                                        ...
                                        <td class="w-2/4 px-1 py-5">
                                            <div class="flex items-center text-sm">
                                                <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                    ...
                                                    @if (isset($order->thumbnail_service[0]->thumbnail) != null)
                                                        <img class="object-cover w-full h-full rounded"
                                                            src="{{ url(Storage::url($order->thumbnail_service[0]->thumbnail)) }}"
