                                    ...
                                    <td class="px-1 py-5 text-sm w-2/8">
                                        <div class="flex items-center text-sm">
                                            <div class="relative w-10 h-10 mr-3 rounded-full md:block">
                                                ...
                                                @if (isset($order->order_buyer->detail_user->photo) != null)
                                                    <img class="object-cover w-full h-full rounded"
                                                        src="{{ url(Storage::url($order->order_buyer->detail_user->photo)) }}"
                                            ...
                                            <div>
                                                <p class="font-medium text-black">
                                                    {{ $order->order_buyer->name ?? '' }}</p>
                                                <p class="text-sm text-gray-400">
                                                    {{ $order->order_buyer->detail_user->phone ?? '' }}</p>
                                            </div>
                                        </div>
                                    </td>
                                ...
                                <div class="m-auto text-center">
                                    ...
                                    <div class="relative mt-0 md:mt-6">
                                        ...
                                        @else
                                            ...
                                            <label for="choose"
                                                class="px-4 py-2 mt-2 text-left text-gray-700 rounded-xl bg-serv-hr">Choose
                                                File</label>
                                        @endif
                                    </div>
                                </div>
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        <div class="col-span-6">
                                            ...
                                            <textarea placeholder="Enter your biography here.." type="text" name="note"
                                                ...
                                                rows="4" required {{ isset($order->file) ? 'disabled' : '' }}>{{ $order->note ? old('note') : $order->note }}</textarea>
