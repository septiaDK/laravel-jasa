                        ...
                        <form action="{{ route('member.service.update', [$service['id']]) }}" method="POST"
                            ...
                            <div class="">
                                    ...
                                    <div class="grid grid-cols-6 gap-6">
                                        ...
                                        <div class="col-span-6">
                                            ...
                                            @forelse ($advantage_service as $advantage_item)
                                                <input placeholder="Keunggulan 1" type="text"
                                                    ...
                                                    id="advantage-servicse" autocomplete="advantage-services"
                                                    class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm"
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="delivery_time" name="delivery_time" autocomplete="delivery_time"
                                                ...
                                                <option value="2" @selected("2"==$service->delivery_time)>2 Hari</option>
                                                <option value="4" @selected("4"==$service->delivery_time)>4 Hari</option>
                                                <option value="8" @selected("8"==$service->delivery_time)>8 Hari</option>
                                                <option value="16" @selected("16"==$service->delivery_time)>16 Hari</option>
                                                <option value="32" @selected("32"==$service->delivery_time)>32 Hari</option>
                                            </select>
                                        ...
                                        <div class="col-span-6 sm:col-span-3">
                                            <select id="revision_limit" name="revision_limit" autocomplete="revision_limit"
                                                ...
                                                <option value="2" @selected("2"==$service->revision_limit)>2 Revisi</option>
                                                <option value="5" @selected("5"==$service->revision_limit)>5 Revisi</option>
                                                <option value="7" @selected("7"==$service->revision_limit)>7 Revisi</option>
                                                <option value="10" @selected("10"==$service->revision_limit)>10 Revisi
                                                </option>
                                                <option value="12" @selected("12"==$service->revision_limit)>12 Revisi
                                                </option>
                                            </select>
                                ...
                                <div class="px-4 py-3 text-right sm:px-6">
                                    ...
                                    <button type="submit"
                                        class="inline-flex justify-center px-4 py-2 text-sm font-medium text-white bg-green-600 border border-transparent rounded-lg shadow-sm hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500" onclick="return confirm('Are you sure want to submit this data?')">
                                        Save Changes
                                    </button>
...
@push('after-script')
    ...
    <script type="text/javascript">
        ...
        $("#addAdvantagesRow").click(function() {
            var html = '';
            html +=
                '<input placeholder="Keunggulan User" type="text" name="advantage-user[]" id="advantage-user" autocomplete="advantage-user" class="block w-full py-3 mt-1 border-gray-300 rounded-md shadow-sm focus:ring-green-500 focus:border-green-500 sm:text-sm">';
