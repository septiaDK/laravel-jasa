...
class ProfileController extends Controller
{
    ...
    public function index()
    {
        ...
        $experience_user = ExperienceUser::where('detail_users_id', $user->detail_user->id)
            ->orderBy('id', 'asc')
            ->get();
     ...
     * @return \Illuminate\Http\Response
     */
    public function update(UpdateProfileRequest $request_profil, UpdateDetailUserRequest $request_detail_user)
    {
        $data_profile = $request_profil->all();
        ...
        $experience_user_id = ExperienceUser::where('detail_users_id', $detail_user['id'])->first();
        if (isset($experience_user_id)) {

            foreach ($data_profile['experience'] as $key => $value) {
                $experience_user = ExperienceUser::find($key);
                $experience_user->detail_users_id = $detail_user['id'];
