...
use App\Http\Requests\Dashboard\Order\UpdateMyOrderRequest;
...
class MyOrderController extends Controller
{
    ...
    public function show(Order $order)
    {
        ...
        return view('pages.dashboard.order.detail', compact('order', 'service', 'advantage_service', 'thumbnail', 'advantage_user', 'tagline'));
    }
    ...
    public function update(UpdateMyOrderRequest $request, Order $order)
    {
        ...
        toast()->success("submit folder has been success");
    ...
    public function rejected($id)
    {
        ...
        toast()->success('Rejected has been success');
        return back();
    }
}
